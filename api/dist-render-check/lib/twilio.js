...
export const twilioClient = env.twilioAccountSid && env.twilioAuthToken
    ...
    : null;
export function validateTwilioSignature(url, signature, body) {
    if (!signature || !env.twilioWebhookAuthToken)
        return false;
