...
export async function deriveOnboardingState(businessId: string): Promise<BusinessOnboardingState> {
...
export async function syncBusinessOnboardingState(businessId: string): Promise<BusinessOnboardingState> {
